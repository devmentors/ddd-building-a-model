...
namespace DDD.BuildingBlocks.Core.V4.LifecycleAligned.Order
{
    public sealed class Order
    {
        ...
        public static Order CreateFromRawData(
            ...
            Payment payment,
            Guid? id = null) 
            => new Order(customerId, lines, shipment, payment, id);
